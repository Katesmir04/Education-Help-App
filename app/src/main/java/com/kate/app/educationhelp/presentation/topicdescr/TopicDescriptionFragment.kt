 ...
 * Use the [TopicDescriptionFragment.newInstance] factory method to
...
class TopicDescriptionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TopicDescriptionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TopicDescriptionFragment().apply {
